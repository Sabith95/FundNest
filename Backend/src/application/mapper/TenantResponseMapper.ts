...
export class TenantResponseMapper {
  ...
  static toUpdateBankDetailsResponse(
    tenant: Tenant,
  ): UpdateBankDetailsResponseDto["tenant"] {
    return {
      id: tenant.id,
      onboardingStep: tenant.onboardingStep,
  ...
  static toUpdateBusinessInfoResponse(
    tenant: Tenant,
  ): UpdateBusinessInfoResponseDto["tenant"] {
    return {
      id: tenant.id,
      onboardingStep: tenant.onboardingStep,
      ...
      businessInfo: tenant.businessInfo
        ? {
            ...
            verification: {
              ...
              verifiedAt:
                tenant.businessInfo.verification?.verifiedAt?.toISOString(),
            },
          }
        : undefined,
      kycDocuments: tenant.kycDocuments
        ? {
            businessRegistrationCertificate: tenant.kycDocuments
              .businessRegistrationCertificate
              ? {
                  objectKey:
                  ...
                  verification: {
                    ...
                    verifiedAt:
                      tenant.kycDocuments.businessRegistrationCertificate.verification?.verifiedAt?.toISOString(),
                  },
                }
              : undefined,
                  ...
                  verification: {
                    ...
                    rejectionReason:
                      tenant.kycDocuments.ownerIdProof.verification
                        ?.rejectionReason,
                    verifiedAt:
                      tenant.kycDocuments.ownerIdProof.verification?.verifiedAt?.toISOString(),
                  },
                }
              : undefined,
          }
      ...
      bankDetails: tenant.bankDetails
        ? {
            ...
            verification: {
              ...
              verifiedAt:
                tenant.bankDetails.verification?.verifiedAt?.toISOString(),
            },
          }
        : undefined,
    };
