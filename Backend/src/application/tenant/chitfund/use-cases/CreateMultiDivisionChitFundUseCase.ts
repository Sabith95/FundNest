...
import { CreateMultiDivisionChitFundDto } from "../dto/CreateMultiDivisionChitFundDto";
import { ChitFundResponseDto } from "../dto/ChitFundResponseDto";
import { ICreateMultiDivisionChitFundUseCase } from "../../../interface/tenant/chitfund/ICreateMultiDivisionChitFundUseCase";
import { MESSAGES } from "../../../../shared/constants/messages";

@injectable()
export class CreateMultiDivisionChitFundUseCase implements ICreateMultiDivisionChitFundUseCase {
  constructor(
  ...
  async execute(
    ...
    if (!dto.division || dto.division < 2) {
      throw new BadRequestError(
        MESSAGES.FUND.MULTI_DIVISION_FUND_MUST_HAVE_DIVISION,
      );
    }
