...
import {
  ...
  resendTenantOtpSchema,
  verifyTenantOtpSchema,
} from "../../validators/tenant/tenantAuthValidators";
...
export class TenantAuthController {
  ...
  verifyTenantOtp = async (
    ...
    try {
      ...
      ResponseHandler.success(res, HTTP_STATUS.OK, MESSAGES.AUTH.OTP_VERIFIED, {
        email: result.email,
  ...
  requestPasswordResetOtp = async (
    ...
    try {
      ...
      const result =
        await this._requestTenantPasswordResetOtpUseCase.execute(payload);
      ResponseHandler.success(
        res,
        HTTP_STATUS.OK,
  ...
  verifyPasswordResetOtp = async (
    ...
    try {
      ...
      const result =
        await this._verifyTenantPasswordResetOtpUseCase.execute(payload);
      ResponseHandler.success(
        res,
        HTTP_STATUS.OK,
        MESSAGES.AUTH.OTP_VERIFIED,
