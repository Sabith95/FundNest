...
const SuperAdminLoginPage = lazyWithRetry(
  () => import("../pages/superAdmin/auth/LoginPage"),
);
const SuperAdminDashboardPage = lazyWithRetry(
  () => import("../pages/superAdmin/dashboard/DashboardPage"),
);
const TenantManagement = lazyWithRetry(
  () => import("../pages/superAdmin/Tenant/TenantManagement"),
);
const TenantDetailsPage = lazyWithRetry(
  () => import("../pages/superAdmin/Tenant/TenantDetailsPage"),
);
const UserManagement = lazyWithRetry(
  () => import("../pages/superAdmin/user/UserManagement"),
);
...
const UserRegisterPage = lazyWithRetry(
  () => import("../pages/user/auth/RegisterPage"),
);
const UserLoginPage = lazyWithRetry(
  () => import("../pages/user/auth/LoginPage"),
);
const OtpPage = lazyWithRetry(() => import("../pages/user/auth/OtpPage"));
const ForgotPasswordPage = lazyWithRetry(
  () => import("../pages/user/auth/ForgotPasswordPage"),
);
const ForgotPasswordOtpPage = lazyWithRetry(
  () => import("../pages/user/auth/ForgotPasswordOtpPage"),
);
const ResetPasswordPage = lazyWithRetry(
  () => import("../pages/user/auth/ResetPasswordPage"),
);
...
const UserLandingPage = lazyWithRetry(
  () => import("../pages/landing/UserLandingPage"),
);
const TenantLandingPage = lazyWithRetry(
  () => import("../pages/landing/TenantLandingPage"),
);
...
const TenantRegisterPage = lazyWithRetry(
  () => import("../pages/Tenant/auth/TenantRegisterPage"),
);
const OtpVerificationPage = lazyWithRetry(
  () => import("../pages/Tenant/auth/OtpPage"),
);
const BusinessSetup = lazyWithRetry(
  () => import("../pages/Tenant/Business/BusinessSetup"),
);
const KycUpload = lazyWithRetry(() => import("../pages/Tenant/Kyc/KycUpload"));
const BankingDetails = lazyWithRetry(
  () => import("../pages/Tenant/Banking/BankingDetails"),
);
const LoginPage = lazyWithRetry(
  () => import("../pages/Tenant/login/LoginPage"),
);
const TenantDashboardPage = lazyWithRetry(
  () => import("../pages/Tenant/Dashboard/TenantDashboardPage"),
);
const TenantForgotPasswordEmailPage = lazyWithRetry(
  () => import("../pages/Tenant/auth/ForgotPasswordEmailPage"),
);
const TenantForgotPasswordOtpPage = lazyWithRetry(
  () => import("../pages/Tenant/auth/ForgotPasswordOtpPage"),
);
const TenantResetPasswordPage = lazyWithRetry(
  () => import("../pages/Tenant/auth/ResetPasswordPage"),
);
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route element={<PublicRoute />}>
              ...
              <Route
                path={ROUTES.TENANT.FORGOT_PASSWORD}
                element={<TenantForgotPasswordEmailPage />}
              />
              <Route
                path={ROUTES.TENANT.FORGOT_PASSWORD_OTP}
                element={<TenantForgotPasswordOtpPage />}
              />
              <Route
                path={ROUTES.TENANT.RESET_PASSWORD}
            ...
            >
              ...
              />
              <Route
                path={ROUTES.SUPER_ADMIN.TENANT_MANAGEMENT}
                element={<TenantManagement />}
              />
              <Route
                path={ROUTES.SUPER_ADMIN.TENANT_DETAILS}
            ...
            >
              <Route
                element={<TenantGuard requireOnboardingComplete={false} />}
              >
                <Route
