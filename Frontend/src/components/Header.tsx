    ...
    <header className="h-14 bg-white border-b border-gray-100 flex items-center px-4 sm:px-6 gap-4 sticky top-0 z-20 flex-shrink-0">
      ...
      <div className="flex items-center gap-2 ml-auto flex-shrink-0">
        ...
        <div className="flex items-center gap-2.5 cursor-pointer group">
          ...
          {/* Avatar */}
          <div
            className="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 group-hover:ring-2 group-hover:ring-blue-200 transition-all"
