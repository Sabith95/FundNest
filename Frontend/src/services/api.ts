...
export const getAccessTokenKey = (roleOrScope?: Role | AuthScope): string => {
  if (
    roleOrScope === AUTH_SCOPE.SUPER_ADMIN ||
    roleOrScope === AUTH_SCOPE.USER ||
    roleOrScope === AUTH_SCOPE.TENANT
  ) {
...
export const getCurrentAccessToken = (
  scope: AuthScope = getAuthScopeFromPath(),
): string | null => {
...
export const refreshAccessToken = async (
  ...
  refreshTokenRequests[scope] = axios
    .post(
