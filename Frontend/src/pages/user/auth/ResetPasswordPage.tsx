...
const PasswordField: React.FC<IPasswordFieldProps> = ({
  ...
  <div>
    ...
    >
      <span
        className={`flex-shrink-0 ${error ? "text-red-400" : "text-gray-400"}`}
      >
        {icon}
      </span>
      <input
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
                Choose a strong password to secure your institutional assets.
              </p>
            </div>
              ...
              <div>
                ...
                {values.newPassword && (
                  <div className="mt-3 flex flex-col gap-1.5">
                    {[
                      {
                        rule: values.newPassword.length >= 8,
                        text: "At least 8 characters",
                      },
                      {
                        rule: /[A-Z]/.test(values.newPassword),
                      ...
                      {
                        rule: /[0-9]/.test(values.newPassword),
                        text: "One number",
                      },
                      {
                        rule: /[^A-Za-z0-9]/.test(values.newPassword),
