...
const LeftPanel: React.FC = () => (
  <div
    ...
    style={{
      background:
        "linear-gradient(160deg, #0f2c5c 0%, #1a5276 45%, #0e7a6e 100%)",
      minHeight: "100vh",
    }}
  >
    ...
    <div className="relative z-10 flex flex-col h-full justify-between p-10 xl:p-14">
      ...
      <div>
        ...
        <p className="text-blue-200 text-base leading-relaxed max-w-xs opacity-75 mb-10">
          Experience a new standard in digital wealth management where precision
          meets prestige.
        </p>
        ...
        >
          ...
          >
            ...
            {/* Arrow head */}
            <polygon points="360,28 348,42 372,42" fill="url(#arrowGrad)" />
      ...
      <div className="flex items-center gap-3">
        ...
        <p className="text-white text-sm font-medium opacity-80">
          Joined by <span className="font-bold opacity-100">12,000+</span>{" "}
          investors globally
        </p>
      </div>
    </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-12 xl:px-16 max-w-lg w-full mx-auto">
          ...
          >
            ...
            <div>
              ...
              >
                <span
                  className={`flex-shrink-0 ${getFieldError("email") ? "text-red-400" : "text-gray-400"}`}
                >
                  <EmailIcon />
                </span>
                <input
            ...
            <div>
              ...
              >
                <span
                  className={`flex-shrink-0 ${getFieldError("password") ? "text-red-400" : "text-gray-400"}`}
                >
                  <LockIcon />
                </span>
                <input
