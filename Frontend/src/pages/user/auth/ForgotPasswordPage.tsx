...
const LeftPanel: React.FC = () => (
  <div
    ...
    style={{
      background:
        "linear-gradient(160deg, #0a1f6e 0%, #0d2580 60%, #0a2080 100%)",
    }}
  >
    {/* Subtle dot pattern */}
    <div
    ...
    <div className="relative z-10 flex flex-col h-full min-h-0 p-6 xl:p-8">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center py-5 xl:py-7">
        ...
        <h2
          ...
          style={{ fontSize: "clamp(2.5rem, 3.6vw, 3.8rem)" }}
        >
          Institutional
          <br />
          Grade
        ...
        <p className="text-blue-100 text-sm xl:text-base leading-relaxed max-w-sm opacity-80">
          Experience the authority of legacy banking combined with the fluid
          precision of modern architectural design.
        </p>
      </div>
      ...
      >
        ...
        <div className="px-4 py-3">
          <p className="text-blue-200 text-xs xl:text-sm italic leading-relaxed opacity-80">
            "The architecture of your wealth deserves nothing less than
            precision."
          </p>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-sm">
                We'll send a verification code to reset your password. Please
            ...
            {isSuccess ? (
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-5">
                  ...
                  >
                    <span
                      className={`flex-shrink-0 ${fieldError ? "text-red-400" : "text-gray-400"}`}
                    >
                      <ContactIcon />
                    </span>
                    <input
            ...
            {["Privacy Policy", "Support Center", "Security Details"].map(
              (item, i, arr) => (
                <React.Fragment key={item}>
                  ...
                  {i < arr.length - 1 && (
                    <span className="text-gray-200 text-lg leading-none">
                      •
                    </span>
                  )}
                </React.Fragment>
