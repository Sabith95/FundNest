...
const LeftPanel: React.FC = () => (
  <div
    ...
    style={{
      background:
        "linear-gradient(135deg, #0f2c5c 0%, #1a5276 40%, #0e6655 100%)",
      minHeight: "100vh",
    }}
  >
    {/* Noise overlay */}
    ...
    <div className="relative z-10 p-10 xl:p-14 flex flex-col h-full justify-between">
      ...
      <div>
        ...
        <p
          ...
          style={{ opacity: 0.8 }}
        >
          Experience a modern approach to collaborative growth and
          institutional-grade private wealth management.
        </p>
      </div>
          ...
          >
            ...
            {[0, 30, 60, 90, 120, 150].map((angle, i) => (
              <ellipse
                ...
                cx="200"
                cy="155"
                rx={Math.abs(Math.cos((angle * Math.PI) / 180)) * 110}
                ry="110"
                fill="none"
                stroke="#00d4aa"
                strokeWidth="0.4"
...
const UserRegisterPage: React.FC = () => {
  ...
  const handleChange = (
    ...
    if (touched[name]) {
      ...
      setErrors((prev) => ({
        ...prev,
        [name]: newErrors[name as keyof IRegisterFormErrors],
      }));
    }
  };
