...
/**
 * FundNest Tenant Landing Page
 *
 * This is the original FundNest landing page, kept as-is in content and
 * design, now scoped to ROUTES.COMMON.TENANT_LANDING. A Tenant is the fund
 * operator: they subscribe, create funds (normal or multi-division),
 * manage members, conduct lots, and distribute payouts.
 *
 * Only change from the original: the page-specific header/footer markup
 * was pulled out into the shared <Header /> / <Footer /> components so all
 * three landing pages (Main, Tenant, User) stay visually and structurally
 * in sync.
 */
