        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            {["About Us", "Security"].map((l) => (
              <button
                key={l}
                className="text-[13px] text-gray-500 hover:text-gray-800 text-left transition-colors"
              >
                {l}
              </button>
            ))}
...
const TenantRegisterPage: React.FC = () => {
  ...
  const err = (f: string) =>
    touched[f] ? errors[f as keyof IRegisterErrors] : undefined;
            ...
            <div className="flex flex-col lg:flex-row min-h-[600px]">
              ...
              <div className="lg:w-[46%] px-8 sm:px-12 py-12 flex flex-col justify-center relative overflow-hidden">
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(134,239,172,0.35) 0%, rgba(134,239,172,0.08) 60%, transparent 100%)",
                  }}
                />
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <span className="block" style={{ color: "#4338ca" }}>
                      Digital Vault
                    </span>
                  </h1>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    >
                      ...
                      <div className="pt-0.5">
                        <p className="text-[13px] font-bold text-[#1a3a6e] mb-1">
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #1a2f6e 0%, #1a78d4 100%)",
                      }}
                    >
                      {loading ? (
                        <>
