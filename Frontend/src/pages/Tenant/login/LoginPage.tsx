...
//           Register
//         </a>
//         <a href="#" className="relative font-semibold text-[#3730a3]">
//           Login
//           <span className="absolute -bottom-[18px] left-0 h-0.5 w-full bg-[#3730a3]" />
//         </a>
//       </nav>

//       <button
//         type="button"
//         className="rounded-full bg-[#0f1a3c] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#1a2a5e] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3730a3] focus-visible:ring-offset-2"
//       >
//         Get Started
//       </button>
//     </div>
...
//         <a href="#" className="font-semibold text-[#3730a3] hover:text-[#2c2582]">
//           Create Vault
//         </a>
//       </p>
