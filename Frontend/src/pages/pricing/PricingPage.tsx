  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <h4 className="text-indigo-600 font-semibold text-[14px] leading-snug">
          {item.question}
        </h4>
    ...
    return (
      <div className="relative z-10 flex flex-col">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(150deg, #3730a3 0%, #4f46e5 45%, #6d5bde 100%)",
          }}
        >
          {/* Name + tagline */}
          <div>
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl px-6 py-8 flex flex-col gap-5 shadow-sm hover:shadow-md transition-shadow self-center w-full">
      ...
      <div className="flex items-baseline gap-1">
        <span className="text-gray-900 text-3xl font-extrabold tracking-tight">
          {plan.price}
        </span>
    ...
    <div className="min-h-screen bg-gray-50 font-sans antialiased">
      ...
      <section className="pt-14 pb-8 px-6 text-center">
        ...
        <p className="text-gray-500 text-[15px] leading-relaxed max-w-md mx-auto">
          Transparent pricing for individual savers and institutional fund
          managers.
            ...
            <div className="flex flex-col gap-7">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Every transaction is layered with AES-256 encryption,
                    ensuring your vault remains private and impenetrable.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Automated reporting tools keep your chit fund operations
                    fully compliant with regional financial laws.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {faqs.map((faq) => (
            ...
            >
              <h4 className="text-indigo-600 font-semibold text-[14px] mb-2">
                {faq.question}
              </h4>
              <p className="text-gray-500 text-sm leading-relaxed">
                {faq.answer}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-400 text-xs leading-relaxed max-w-[180px]">
                The Digital Vault for your Capital. Pioneering trust in
                community finance.
              </p>
            </div>
            ...
            <div>
              ...
              {["Terms of Service", "Privacy Policy"].map((l) => (
                <a
                  key={l}
                  href="#"
                  className="block text-gray-400 text-xs hover:text-indigo-500 mb-2 transition-colors"
                >
                  {l}
                </a>
              ))}
